...
$erros = "";
if (empty($email)) {
    $erros .= "O e-mail do usuário está vazio.<br>";
}
...
if (!empty($erros))
{
    ...
    echo "<br><br><a href='http://localhost/Agenda/pages/login.php'>Clique aqui para voltar</a>";
}
...
$con = mysqli_connect($host, $user); //tirei password
...
if ($nro_registros == 0) {
    ...
    <html>
    <head>
        <META http-equiv=\"refresh\" content=\"0;URL=http://localhost/Agenda/pages/dashboard.php\">
    </head>
</html>
    ";
}
